...
def main():
    ...
    centres, cov, G = build()
    levels = draw(centres, cov, G, True, OUT_DIR / "fig_4_3_mesh_geometry_annotated.pdf")
    draw(centres, cov, G, False, OUT_DIR / "fig_4_3_mesh_geometry.pdf")
    ...
    print(f"\nsaved {OUT_DIR/'fig_4_3_mesh_geometry.png'} and {OUT_DIR/'fig_4_3_mesh_geometry_annotated.png'}")
