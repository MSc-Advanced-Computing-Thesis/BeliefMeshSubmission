...
from beliefmesh.data.digits import DATA_ROOT
...
def load_digit_instances(indices, mnist_root: str = DATA_ROOT) -> list[torch.Tensor]:
...
def sample_digit_instances(n: int, mnist_root: str = DATA_ROOT, seed: int = 42) -> list[torch.Tensor]:
...
class GridEnvironment:
    ...
    def __init__(self, grid_size: int, environment_grids: np.ndarray,
                 mnist_root: str = DATA_ROOT, rotation_seed: int = 42,
