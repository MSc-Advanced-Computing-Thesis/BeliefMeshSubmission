# Section 5.3 -- three-node colour-world experiment, VERSION 3.
#
...
OUT = Path("runs/chapter5_v2/s5_3_colour_three_node_v3")
...
def build_kwargs(arm, seed, root):
    ...
    return dict(
        ...
        title="Colour three-node v3 (%s, seed=%d)" % (arm, seed),
