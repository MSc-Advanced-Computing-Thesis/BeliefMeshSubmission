# V3 geometry figure. The colour field is imported from the RUN script, not
# reimplemented, so the figure cannot drift from what was actually executed.
#
# Run: python -u experiments/section5_2/make_colour3_v3_geometry.py
...
def main():
    ...
    p = Path("figures") / "ch5_5_3_colour3_v3_geometry.png"
