...
MIXED_ROOT = "runs/chapter5_v2/s5_6_het_fon"
HOMOG_ROOT = "runs/chapter5_v2/s5_6_homog_fon"
STORED_OFF = Path("runs/chapter5_v2/s5_6_het_rg/nig_product/het_nig_product")
FLOOR_PCT = 0.2
_captured: list = []
...
def verify():
    ...
    print("=" * 92)
    out = Path("runs/scratch/het_fon_inert")
