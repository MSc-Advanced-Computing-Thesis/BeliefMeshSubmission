# Deployment-granularity demonstration: 36 nodes at 21x21-cell fields of view.
#
# PURPOSE. Chapter 5 runs at a reduced scale (22x22 grid, 7x7 FOV, 49 cells per
# node). This shows the system operating at deployment cell counts with the
# overlap structure held constant. It is a demonstration of OPERATION, not a
# results run: 36 timesteps shows initial adaptation only.
#
...
G, FOV, STRIDE, N_SIDE, T = 66, 20, 9, 6, 36
N_WEARABLES = 27
OUT = Path("runs/chapter5_v2/s5_deployment_scale")
...
def main():
    ...
    res = run_mesh_experiment(
        ...
        title="Deployment scale (66x66, FOV 20, 27 wearables, seed %d)" % SEED,
