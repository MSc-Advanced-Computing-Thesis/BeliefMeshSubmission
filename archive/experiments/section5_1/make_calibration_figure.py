...
from make_figures import FIGS, GREY, INK, RED, WIDTH, load_csv

HEIGHT = 2.7
NAME = "section5_1_calibration"
...
def main(height: float = HEIGHT, name: str = NAME):
    d = read_dump(Path("runs/section5_1/r1a/per_sample_baseline.csv"))
    cov = load_csv(Path("runs/section5_1/r1a/interval_coverage_fine.csv"))
    ...
    ref = yaml.safe_load(open("runs/section5_1/r1a/summary.yaml"))["reference_passes"]
